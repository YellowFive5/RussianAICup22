...
namespace AiCup22.Model
{
    ...
    public abstract class Item
    {
        ...
        public static Item ReadFrom(BinaryReader reader)
        {
        ...
        public class Weapon : Item
        {
            ...
            public static new Weapon ReadFrom(BinaryReader reader)
            {
        ...
        public class ShieldPotions : Item
        {
            ...
            public static new ShieldPotions ReadFrom(BinaryReader reader)
            {
        ...
        public class Ammo : Item
        {
            ...
            public static new Ammo ReadFrom(BinaryReader reader)
            {
                var result = new Ammo();
