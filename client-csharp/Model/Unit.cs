...
namespace AiCup22.Model
{
    ...
    public struct Unit
    {
        ...
        public Unit(int id, int playerId, double health, double shield, int extraLives, Vec2 position, double? remainingSpawnTime, Vec2 velocity, Vec2 direction, double aim, Action? action, int healthRegenerationStartTick, int? weapon, int nextShotTick, int[] ammo, int shieldPotions)
        {
            Id = id;
            PlayerId = playerId;
            Health = health;
        ...
        public static Unit ReadFrom(BinaryReader reader)
        {
            ...
            result.Direction = Vec2.ReadFrom(reader);
