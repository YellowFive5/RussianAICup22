...
namespace AiCup22.Model
{
    ...
    public struct Constants
    {
        ...
        /// </summary>
        public WeaponProperties[] Weapons { get; set; }
        ...
        /// </summary>
        public SoundProperties[] Sounds { get; set; }
        ...
        public static Constants ReadFrom(BinaryReader reader)
        {
            ...
            result.Weapons = new WeaponProperties[reader.ReadInt32()];
            for (int weaponsIndex = 0; weaponsIndex < result.Weapons.Length; weaponsIndex++)
            {
                result.Weapons[weaponsIndex] = WeaponProperties.ReadFrom(reader);
            }
            ...
            result.Sounds = new SoundProperties[reader.ReadInt32()];
            for (int soundsIndex = 0; soundsIndex < result.Sounds.Length; soundsIndex++)
            {
                result.Sounds[soundsIndex] = SoundProperties.ReadFrom(reader);
            }
            ...
            result.Obstacles = new Obstacle[reader.ReadInt32()];
            for (int obstaclesIndex = 0; obstaclesIndex < result.Obstacles.Length; obstaclesIndex++)
            {
                result.Obstacles[obstaclesIndex] = Obstacle.ReadFrom(reader);
            }
