...
namespace AiCup22.Model
{
    ...
    public abstract class ActionOrder
    {
        ...
        public static ActionOrder ReadFrom(BinaryReader reader)
        {
        ...
        public class Pickup : ActionOrder
        {
            ...
            public static new Pickup ReadFrom(BinaryReader reader)
            {
        ...
        public class UseShieldPotion : ActionOrder
        {
            ...
            public static new UseShieldPotion ReadFrom(BinaryReader reader)
            {
        ...
        public class DropShieldPotions : ActionOrder
        {
            ...
            public static new DropShieldPotions ReadFrom(BinaryReader reader)
            {
        ...
        public class DropWeapon : ActionOrder
        {
            ...
            public static new DropWeapon ReadFrom(BinaryReader reader)
            {
        ...
        public class DropAmmo : ActionOrder
        {
            ...
            public static new DropAmmo ReadFrom(BinaryReader reader)
            {
        ...
        public class Aim : ActionOrder
        {
            ...
            public static new Aim ReadFrom(BinaryReader reader)
            {
                var result = new Aim();
